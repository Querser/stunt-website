  ...
  return (
    <section className="relative overflow-hidden border-t border-white/10 bg-[#040404]">
      <div className="homePage-container grid items-center gap-9 py-14 sm:py-16 lg:grid-cols-[1fr_1.04fr] lg:gap-12 lg:py-20">
        ...
        <div>
          <h2 className="home-main-title text-[clamp(2.95rem,7vw,5.6rem)] leading-[0.9] tracking-[-0.03em] text-white">
          ...
          <p className="mt-6 max-w-[560px] text-sm leading-7 text-white/72 sm:text-base sm:leading-8">
            Stunt Tech зародился в гаражной пыли и запахе перегретого масла. Мы строим место для своих: тех, кто не представляет жизнь без
            станта, ночных переборок и чистого проезда в выходные.
          </p>

          <ul className="mt-8 grid grid-cols-2 gap-4 sm:mt-10 sm:gap-5">
            {stats.map(({ value, label, Icon }) => (
              <li key={label} className="story-stat-card px-4 py-4">
